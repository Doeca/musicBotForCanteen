    ...
    return function(t) {
        ...
        m._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/,
            ...
            o.prototype.smartypants = function(t) {
                return this.options.smartypants ? t.replace(/---/g, "¡ª").replace(/--/g, "¨C").replace(/(^|[-\u2014\/(\[{"\s])'/g, "$1¡®").replace(/'/g, "¡¯").replace(/(^|[-\u2014\/(\[{\u2018\s])"/g, "$1¡°").replace(/"/g, "¡±").replace(/\.{3}/g, "¡­") : t
            },
                                ...
                                u.open("GET", o, !0),
                                    u.onreadystatechange = function() {
                                        4 == u.readyState && (u.status < 400 && u.responseText ? (c.textContent = u.responseText,
                                            r.highlightElement(c)) : u.status >= 400 ? c.textContent = "7¾0 Error " + u.status + " while fetching file: " + u.statusText : c.textContent = "7¾0 Error: File does not exist or is empty")
                                    },
                                    u.send(null)
                            })
                        },
