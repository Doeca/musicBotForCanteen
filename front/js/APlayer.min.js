                    ...
                    value: function(e) {
                        ...
                        if (!this.parsed[e])
                            if (this.async) {
                                ...
                                this.player.list.audios[e].lrc ? this.parsed[e] = this.parse(this.player.list.audios[e].lrc) : this.parsed[e] = [
                                    ["00:00", "Not available"]
                                ];
                ...
                return i(e, [{
                        ...
                        value: function() {
                            ...
                            this.on("error", function() {
                                    e.list.audios.length ? (e.notice("An audio error has occurred, player will skip forward in 2 seconds."),
                                        t = setTimeout(function() {
                                            e.skipForward(),
                                                e.paused || e.play()
